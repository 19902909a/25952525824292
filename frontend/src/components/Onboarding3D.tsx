    ...
    <AnimatePresence>
      ...
      >
        <div className="relative rounded-3xl overflow-hidden border border-white/10 bg-black/40 backdrop-blur-xl shadow-[0_20px_60px_rgba(0,0,0,0.6),0_0_0_1px_rgba(255,255,255,0.05)_inset]">
          ...
          <div className="p-5 text-center relative z-10 border-t border-white/10 bg-black/60">
            ...
            <div className="flex justify-between items-center w-full">
              <div className="flex gap-2">
                {stepsData.map((_, i) => (
                  <div key={i} className={`w-2 h-2 rounded-full transition-all duration-300 ${i === step ? 'bg-gradient-to-r ' + currentData.color + ' w-4' : 'bg-white/20'}`} />
                ))}
              </div>
