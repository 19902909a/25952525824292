      ...
      <div className="relative overflow-hidden" data-testid="root-landing-page">
        ...
        <section className="mx-auto w-full max-w-6xl px-4 pb-12 pt-8 sm:px-6 sm:pb-16 sm:pt-12 lg:px-8 lg:pb-24 lg:pt-20">
          <div className={`${luxurySection} p-5 sm:p-7 lg:p-10`}>
            ...
            <div
              ref={bannerShellRef}
              className="hero-banner-3d relative overflow-hidden rounded-[1.25rem] min-h-[380px] w-full md:w-[70%] mx-auto ring-1 ring-white/10 shadow-2xl"
            ...
            >
              ...
              <div className="hero-banner-content relative flex min-h-[380px] flex-col justify-end p-4 sm:p-6 lg:p-8 z-30 pointer-events-none">
